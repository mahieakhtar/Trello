describe("Login", function () {
  ...
  it("create a new board", function () {
    ...
    //Delete Some of the Comments(Delete first and fifth comment)
    it("Delete Comments", function () {
      cy.contains("CypressTesting").click();
      cy.get(".js-confirm-delete-action").contains("Delete").click();
      cy.get('input[type="submit"]').contains("Delete Comment").click();
    });
  });
});
