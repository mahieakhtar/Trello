describe("Login", function () {
  ...
  it("create a new board", function () {
    ...
    it("Move Card ", function () {
      cy.contains("CypressTesting").click();
      cy.get(".js-sidebar-action-text").contains("Move").click();
      cy.get('input[selected="selected"]').contains("Doing").click();
      cy.get('input[type="submit"]').contains("Move").click();
      //   cy.get(".icon-md icon-close dialog-close-button js-close-window")
      //     .contains("x")
      //     .click();
    });

    //Edit Some of the Comments(Edit second and third comment)
    it("Edit Comments", function () {
      cy.contains("CypressTesting").click();
      cy.get(".js-edit-action").contains("Edit").click();
      cy.get('input[type="submit"]').contains("Save").click();
    });

    //Delete the moved card
    it("Delete Moved Card", function () {
      cy.contains("CypressTesting").click();
      cy.get(".js-sidebar-action-text").contains("Archive").click();
      cy.get(".js-sidebar-action-text").contains("-Delete").click();
